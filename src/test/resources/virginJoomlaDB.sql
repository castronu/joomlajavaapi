...
--
-- Host: localhost
-- Generato il: Mar 05, 2014 alle 04:25
...
--
-- Database: `joomlajavaapi`
--

-- --------------------------------------------------------

--
-- Struttura della tabella `r7t61_assets`
--

CREATE TABLE `r7t61_assets` (
...
--
-- Dump dei dati per la tabella `r7t61_assets`
--

INSERT INTO `r7t61_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Struttura della tabella `r7t61_associations`
--

CREATE TABLE `r7t61_associations` (
...
--
-- Struttura della tabella `r7t61_banners`
--

CREATE TABLE `r7t61_banners` (
...
--
-- Struttura della tabella `r7t61_banner_clients`
--

CREATE TABLE `r7t61_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Struttura della tabella `r7t61_banner_tracks`
--

CREATE TABLE `r7t61_banner_tracks` (
...
--
-- Struttura della tabella `r7t61_categories`
--

CREATE TABLE `r7t61_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dump dei dati per la tabella `r7t61_categories`
--

INSERT INTO `r7t61_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- Struttura della tabella `r7t61_contact_details`
--

CREATE TABLE `r7t61_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Struttura della tabella `r7t61_content`
--

CREATE TABLE `r7t61_content` (
...
--
-- Struttura della tabella `r7t61_contentitem_tag_map`
--

CREATE TABLE `r7t61_contentitem_tag_map` (
...
--
-- Struttura della tabella `r7t61_content_frontpage`
--

CREATE TABLE `r7t61_content_frontpage` (
...
--
-- Struttura della tabella `r7t61_content_rating`
--

CREATE TABLE `r7t61_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Struttura della tabella `r7t61_content_types`
--

CREATE TABLE `r7t61_content_types` (
...
--
-- Dump dei dati per la tabella `r7t61_content_types`
--

INSERT INTO `r7t61_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Struttura della tabella `r7t61_core_log_searches`
--

CREATE TABLE `r7t61_core_log_searches` (
...
--
-- Struttura della tabella `r7t61_extensions`
--

CREATE TABLE `r7t61_extensions` (
...
--
-- Dump dei dati per la tabella `r7t61_extensions`
--

INSERT INTO `r7t61_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2014 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":""}', '{"mediaversion":"7d1947a91217937953b9edf01d89b40e"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Struttura della tabella `r7t61_finder_filters`
--

CREATE TABLE `r7t61_finder_filters` (
...
--
-- Struttura della tabella `r7t61_finder_links`
--

CREATE TABLE `r7t61_finder_links` (
...
--
-- Struttura della tabella `r7t61_finder_links_terms0`
--

CREATE TABLE `r7t61_finder_links_terms0` (
...
--
-- Struttura della tabella `r7t61_finder_links_terms1`
--

CREATE TABLE `r7t61_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `r7t61_finder_links_terms2`
--

CREATE TABLE `r7t61_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `r7t61_finder_links_terms3`
--

CREATE TABLE `r7t61_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `r7t61_finder_links_terms4`
--

CREATE TABLE `r7t61_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `r7t61_finder_links_terms5`
--

CREATE TABLE `r7t61_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `r7t61_finder_links_terms6`
--

CREATE TABLE `r7t61_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `r7t61_finder_links_terms7`
--

CREATE TABLE `r7t61_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `r7t61_finder_links_terms8`
--

CREATE TABLE `r7t61_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `r7t61_finder_links_terms9`
--

CREATE TABLE `r7t61_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `r7t61_finder_links_termsa`
--

CREATE TABLE `r7t61_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `r7t61_finder_links_termsb`
--

CREATE TABLE `r7t61_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `r7t61_finder_links_termsc`
--

CREATE TABLE `r7t61_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `r7t61_finder_links_termsd`
--

CREATE TABLE `r7t61_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `r7t61_finder_links_termse`
--

CREATE TABLE `r7t61_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `r7t61_finder_links_termsf`
--

CREATE TABLE `r7t61_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `r7t61_finder_taxonomy`
--

CREATE TABLE `r7t61_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dump dei dati per la tabella `r7t61_finder_taxonomy`
--

INSERT INTO `r7t61_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Struttura della tabella `r7t61_finder_taxonomy_map`
--

CREATE TABLE `r7t61_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Struttura della tabella `r7t61_finder_terms`
--

CREATE TABLE `r7t61_finder_terms` (
...
--
-- Struttura della tabella `r7t61_finder_terms_common`
--

CREATE TABLE `r7t61_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dump dei dati per la tabella `r7t61_finder_terms_common`
--

INSERT INTO `r7t61_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Struttura della tabella `r7t61_finder_tokens`
--

CREATE TABLE `r7t61_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Struttura della tabella `r7t61_finder_tokens_aggregate`
--

CREATE TABLE `r7t61_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Struttura della tabella `r7t61_finder_types`
--

CREATE TABLE `r7t61_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Struttura della tabella `r7t61_languages`
--

CREATE TABLE `r7t61_languages` (
...
--
-- Dump dei dati per la tabella `r7t61_languages`
--

INSERT INTO `r7t61_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Struttura della tabella `r7t61_menu`
--

CREATE TABLE `r7t61_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dump dei dati per la tabella `r7t61_menu`
--

INSERT INTO `r7t61_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Struttura della tabella `r7t61_menu_types`
--

CREATE TABLE `r7t61_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dump dei dati per la tabella `r7t61_menu_types`
--

INSERT INTO `r7t61_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Struttura della tabella `r7t61_messages`
--

CREATE TABLE `r7t61_messages` (
...
--
-- Struttura della tabella `r7t61_messages_cfg`
--

CREATE TABLE `r7t61_messages_cfg` (
...
--
-- Struttura della tabella `r7t61_modules`
--

CREATE TABLE `r7t61_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dump dei dati per la tabella `r7t61_modules`
--

INSERT INTO `r7t61_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Struttura della tabella `r7t61_modules_menu`
--

CREATE TABLE `r7t61_modules_menu` (
...
--
-- Dump dei dati per la tabella `r7t61_modules_menu`
--

INSERT INTO `r7t61_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Struttura della tabella `r7t61_newsfeeds`
--

CREATE TABLE `r7t61_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Struttura della tabella `r7t61_overrider`
--

CREATE TABLE `r7t61_overrider` (
...
--
-- Struttura della tabella `r7t61_postinstall_messages`
--

CREATE TABLE `r7t61_postinstall_messages` (
...
--
-- Dump dei dati per la tabella `r7t61_postinstall_messages`
--

INSERT INTO `r7t61_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Struttura della tabella `r7t61_redirect_links`
--

CREATE TABLE `r7t61_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Struttura della tabella `r7t61_schemas`
--

CREATE TABLE `r7t61_schemas` (
...
--
-- Dump dei dati per la tabella `r7t61_schemas`
--

INSERT INTO `r7t61_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.2.2-2014-01-23');

-- --------------------------------------------------------

--
-- Struttura della tabella `r7t61_session`
--

CREATE TABLE `r7t61_session` (
...
--
-- Dump dei dati per la tabella `r7t61_session`
--

INSERT INTO `r7t61_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('dd3534cc4cb0b0ce9770aa08e893986b', 1, 0, '1393989900', '__default|a:8:{s:15:"session.counter";i:4;s:19:"session.timer.start";i:1393989889;s:18:"session.timer.last";i:1393989894;s:17:"session.timer.now";i:1393989895;s:22:"session.client.browser";s:120:"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/33.0.1750.146 Safari/537.36";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":2:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:5:"en-GB";}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}}}s:4:"user";O:5:"JUser":26:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"379";s:4:"name";s:10:"Super User";s:8:"username";s:13:"joomlajavaapi";s:5:"email";s:18:"castronu@gmail.com";s:8:"password";s:34:"$P$D0eppdBFH/zWYR9LGf7KZZADT4xbB7.";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2014-03-05 03:24:44";s:13:"lastvisitDate";s:19:"0000-00-00 00:00:00";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:5:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;i:4;i:6;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;s:6:"otpKey";s:0:"";s:4:"otep";s:0:"";}s:13:"session.token";s:32:"8c0ffa4405dce83de8fd49ae3e048a5b";}', 379, 'joomlajavaapi');

-- --------------------------------------------------------

--
-- Struttura della tabella `r7t61_tags`
--

CREATE TABLE `r7t61_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dump dei dati per la tabella `r7t61_tags`
--

INSERT INTO `r7t61_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 0, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Struttura della tabella `r7t61_template_styles`
--

CREATE TABLE `r7t61_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dump dei dati per la tabella `r7t61_template_styles`
--

INSERT INTO `r7t61_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Struttura della tabella `r7t61_ucm_base`
--

CREATE TABLE `r7t61_ucm_base` (
...
--
-- Struttura della tabella `r7t61_ucm_content`
--

CREATE TABLE `r7t61_ucm_content` (
...
--
-- Struttura della tabella `r7t61_ucm_history`
--

CREATE TABLE `r7t61_ucm_history` (
...
--
-- Struttura della tabella `r7t61_updates`
--

CREATE TABLE `r7t61_updates` (
...
--
-- Dump dei dati per la tabella `r7t61_updates`
--

INSERT INTO `r7t61_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
...
(10, 3, 0, 'EnglishAU', '', 'pkg_en-AU', 'package', '', 0, '3.1.0.1', '', 'http://update.joomla.org/language/details3/en-AU_details.xml', '', ''),
(11, 3, 0, 'EnglishUS', '', 'pkg_en-US', 'package', '', 0, '3.1.0.1', '', 'http://update.joomla.org/language/details3/en-US_details.xml', '', ''),
(12, 3, 0, 'Hungarian', '', 'pkg_hu-HU', 'package', '', 0, '3.2.2.1', '', 'http://update.joomla.org/language/details3/hu-HU_details.xml', '', ''),
(13, 3, 0, 'Afrikaans', '', 'pkg_af-ZA', 'package', '', 0, '3.2.0.1', '', 'http://update.joomla.org/language/details3/af-ZA_details.xml', '', ''),
(14, 3, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '3.2.2.1', '', 'http://update.joomla.org/language/details3/ar-AA_details.xml', '', ''),
...
(17, 3, 0, 'Catalan', '', 'pkg_ca-ES', 'package', '', 0, '3.2.2.1', '', 'http://update.joomla.org/language/details3/ca-ES_details.xml', '', ''),
...
(20, 3, 0, 'Czech', '', 'pkg_cs-CZ', 'package', '', 0, '3.2.2.1', '', 'http://update.joomla.org/language/details3/cs-CZ_details.xml', '', ''),
(21, 3, 0, 'Danish', '', 'pkg_da-DK', 'package', '', 0, '3.2.2.1', '', 'http://update.joomla.org/language/details3/da-DK_details.xml', '', ''),
(22, 3, 0, 'Dutch', '', 'pkg_nl-NL', 'package', '', 0, '3.2.2.1', '', 'http://update.joomla.org/language/details3/nl-NL_details.xml', '', ''),
(23, 3, 0, 'Estonian', '', 'pkg_et-EE', 'package', '', 0, '3.2.2.1', '', 'http://update.joomla.org/language/details3/et-EE_details.xml', '', ''),
(24, 3, 0, 'Dutch', '', 'pkg_nl-NL', 'package', '', 0, '3.2.2.1', '', 'http://update.joomla.org/language/details3/nl-NL_details.xml', '', ''),
...
(45, 3, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.2.2.1', '', 'http://update.joomla.org/language/details3/es-ES_details.xml', '', ''),
(46, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.2.2.1', '', 'http://update.joomla.org/language/details3/bs-BA_details.xml', '', ''),
(47, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.2.2.1', '', 'http://update.joomla.org/language/details3/bs-BA_details.xml', '', ''),
(48, 3, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.2.2.1', '', 'http://update.joomla.org/language/details3/sr-RS_details.xml', '', ''),
...
(51, 3, 0, 'Bahasa Indonesia', '', 'pkg_id-ID', 'package', '', 0, '3.1.4.1', '', 'http://update.joomla.org/language/details3/id-ID_details.xml', '', ''),
(52, 3, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '3.2.2.1', '', 'http://update.joomla.org/language/details3/fi-FI_details.xml', '', ''),
(53, 3, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.2.2.1', '', 'http://update.joomla.org/language/details3/sw-KE_details.xml', '', ''),
(54, 3, 0, 'Montenegrin', '', 'pkg_srp-ME', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/srp-ME_details.xml', '', '');

-- --------------------------------------------------------

--
-- Struttura della tabella `r7t61_update_sites`
--

CREATE TABLE `r7t61_update_sites` (
...
--
-- Dump dei dati per la tabella `r7t61_update_sites`
--

INSERT INTO `r7t61_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1393989897, ''),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1393989897, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1393989895, '');

-- --------------------------------------------------------

--
-- Struttura della tabella `r7t61_update_sites_extensions`
--

CREATE TABLE `r7t61_update_sites_extensions` (
...
--
-- Dump dei dati per la tabella `r7t61_update_sites_extensions`
--

INSERT INTO `r7t61_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- Struttura della tabella `r7t61_usergroups`
--

CREATE TABLE `r7t61_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dump dei dati per la tabella `r7t61_usergroups`
--

INSERT INTO `r7t61_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Struttura della tabella `r7t61_users`
--

CREATE TABLE `r7t61_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dump dei dati per la tabella `r7t61_users`
--

INSERT INTO `r7t61_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`) VALUES
(379, 'Super User', 'joomlajavaapi', 'castronu@gmail.com', '$P$D0eppdBFH/zWYR9LGf7KZZADT4xbB7.', 0, 1, '2014-03-05 03:24:44', '2014-03-05 03:24:54', '0', '', '0000-00-00 00:00:00', 0, '', '');

-- --------------------------------------------------------

--
-- Struttura della tabella `r7t61_user_keys`
--

CREATE TABLE `r7t61_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Struttura della tabella `r7t61_user_notes`
--

CREATE TABLE `r7t61_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Struttura della tabella `r7t61_user_profiles`
--

CREATE TABLE `r7t61_user_profiles` (
...
--
-- Struttura della tabella `r7t61_user_usergroup_map`
--

CREATE TABLE `r7t61_user_usergroup_map` (
...
--
-- Dump dei dati per la tabella `r7t61_user_usergroup_map`
--

INSERT INTO `r7t61_user_usergroup_map` (`user_id`, `group_id`) VALUES
(379, 8);

-- --------------------------------------------------------

--
-- Struttura della tabella `r7t61_viewlevels`
--

CREATE TABLE `r7t61_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dump dei dati per la tabella `r7t61_viewlevels`
--

INSERT INTO `r7t61_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Struttura della tabella `r7t61_weblinks`
--

CREATE TABLE `r7t61_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
