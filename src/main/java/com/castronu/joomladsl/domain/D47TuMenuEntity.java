 ...
 */
@javax.persistence.Table(name = "d47tu_menu", schema = "", catalog = "testJoomlaDsl")
@Entity
public class D47TuMenuEntity {
    private int id;
    ...
    private byte browserNav;

    @javax.persistence.Column(name = "browserNav")
    @Basic
    public byte getBrowserNav() {
        return browserNav;
    }

    public void setBrowserNav(byte browserNav) {
    ...
    public boolean equals(Object o) {
        ...
        D47TuMenuEntity that = (D47TuMenuEntity) o;

        if (access != that.access) return false;
        if (browserNav != that.browserNav) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (int) browserNav;
